        ...
        <div class="wrapper">
          ...
          <section id="content">
            <article>
                ...
                <form method="post" action="loginreg.php">
                  <fieldset><div class="field">
                    <label>Admin Id:</label>
                    <input type="text" value="" id="adminusername" name="adminusername" size="20"/>
                  </div>
				  <br>
                  <div class="field">
                    <label>Password:</label>
                    <input type="password" value="" id="admin_password" name="admin_password" size="20"/>
                  </div>
				  <br>
				   <fieldset><div class="field">
                    <label>User Name:</label>
                    <input type="text" value="" id="usernam" name="username" size="20"/>
                  </div>
				  <br>
